...
(function( window, undefined ) {
    ...
    auiPopup.prototype = {
        ...
        show: function(el){
            ...
            el.style.zIndex = "19";
            document.querySelector('.aui-popup-content').style.height = "100%";
        	setTimeout(function(){
        ...
        hide: function(el){
	        ...
	        setTimeout(function(){
	        	...
	        	document.querySelector(__POPUP).style.zIndex = "1";
                document.querySelector('.aui-popup').style.height = "0px";
                document.querySelector('.aui-popup-content').style.height = "0px";
