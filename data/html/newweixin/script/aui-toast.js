    ...
    auiToast.prototype = {
        create: function(params, callback) {
            ...
            if (params.type == 'toast') {
                ...
                bgHtml = '<div class="aui-mask aui-mask-in toast"></div>';
            }
            var titleHtml = params.title ? '<div class="aui-toast-content' + className + '">' + params.title + '</div>' : '';
            toastHtml = '<div style="z-index:20" class="aui-toast' + className + '">' + iconHtml + titleHtml + '</div>';
            toastHtml += bgHtml;
        ...
        hide: function() {
            ...
            if (document.querySelector(".aui-mask.aui-mask-in.toast")) {
                document.querySelector(".aui-mask.aui-mask-in.toast").parentNode.removeChild(document.querySelector(".aui-mask.aui-mask-in.toast"));
            }
        },
        remove: function() {
