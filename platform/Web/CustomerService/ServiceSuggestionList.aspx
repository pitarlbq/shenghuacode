<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NavContent4.Master" AutoEventWireup="true" CodeBehind="ServiceSuggestionList.aspx.cs" Inherits="Web.CustomerService.ServiceSuggestionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function reloadTT() {
            ...
            top.openTreeContent();
            var curTab = $('#CostTab').tabs('getSelected');
            curTab.find("iframe")[0].contentWindow.$("#tt_table").datagrid("reload");
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="easyui-tabs" id="CostTab" style="width: 100%; height: 99%; border: none;" data-options="tabHeight:35">
        ...
        <div title="调度台" style="padding: 10px">
            <input type="hidden" value="ServiceSuggestionMgr.aspx?status=10" />
            <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
        </div>
        <div title="待派单" style="padding: 10px">
            <input type="hidden" value="ServiceSuggestionMgr.aspx?status=3" />
            <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
        </div>
        ...
        <div title="处理中" style="padding: 10px">
            <input type="hidden" value="ServiceSuggestionMgr.aspx?status=0" />
            <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
        </div>
        ...
        <div title="重大投诉" style="padding: 10px">
            <input type="hidden" value="ServiceSuggestionMgr.aspx?status=200" />
            <iframe src="" style="width: 100%; height: 99%; border: 0"></iframe>
        </div>
    </div>
</asp:Content>
