<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="AddTopyt.aspx.cs" Inherits="Web.InitialSetup.AddTopyt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function setreturnvalue() {
            ...
            if (poststr.length > 0) {
                var options = { visit: 'savenameswithyt', ProjectID: "<%=Request.QueryString["ProjectID"]%>", strjson: JSON.stringify(poststr), OrderBy: $("#gradeorder").val() };
                $.ajax({
                    type: 'POST',
                    dataType: 'html',
                ...
                var final = { title: title, order: $("#gradeorder").val(), list: arry };
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <form id="ff" class="easyui-form" method="post" data-options="novalidate:true">
        <table id="yttable" class="yttable">
            <tr>
                <td style="width: 80px;">业态名称:</td>
                <td>
                    <input id="1_grade" class="easyui-textbox" type="text" name="gradename" data-options="required:true" style="width: 80%" /></td>
                <td style="width: 60px;">排序:
                    <input id="gradeorder" class="easyui-textbox" type="text" data-options="required:true" style="width: 40%" />
                </td>
                <td style="width: 80px;">
                    <label>
