...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function getProjectData(phoneNumber, RoomID, isNotRoom) {
            ...
            var options = { visit: "getroominfo", phoneNumber: phoneNumber, includeHistory: true, ProjectID: RoomID, IsNotRoom: isNotRoom, ServiceTypeID: ServiceTypeID, UserID: top.UserID };
            $.ajax({
                type: 'POST',
                data: options,
                dataType: 'json',
        ...
        function getHomeData() {
            var options = { visit: "gethomecountdata", UserID: top.UserID };
            $.ajax({
                type: 'POST',
                data: options,
                dataType: 'json',
