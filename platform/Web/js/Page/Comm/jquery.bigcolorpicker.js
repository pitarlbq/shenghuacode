    ...
    var bigColorPicker = new function () {
        ...
        this.showPicker = function (callback, engine, sideLength_) {
            ...
            this.getAllColorArray = function () {
                allColorArray = new Array(sideLength * 3 + painyi);
                //计算第一列的数组
                var mixColorArray = [];
            ...
            if (engine == "L") {
                ...
                $("#bigSections li").hover(function () {
                    var $this = $(this);
                    $("#bigLayout").css({ "left": $this.position().left + painyi, "top": $this.position().top + painyi }).show();
                ...
                bgmage.src = "../styles/images/big_bgcolor.jpg";
                //初始化为默认样式
                ...
                $("#bigSections").unbind("mousemove").unbind("mouseout").mousemove(function (event) {
                    ...
                    $("#bigLayout").css({ "left": $this.position().left + xi * 11 + painyi, "top": $this.position().top + yi * 11 + painyi }).show();
            ...
            $(this).bind("click", function (event) {
                ...
                $("#bigLayout").css({ "left": bigSectionsP.left + painyi, "top": bigSectionsP.top + painyi }).show();
