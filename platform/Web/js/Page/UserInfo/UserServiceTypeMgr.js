...
function loadoperationTree() {
    var url = "../Handler/AuthMgrHandler.ashx?visit=loadservicetypetree";
...
function do_save_operation(UserID, RoleID) {
    ...
    $.ajax({
        ...
        data: { visit: "saveservicetypeoperation", IdList: idList, UserID: UserID, RoleID: RoleID },
...
function loadOperation(roleId, UserID) {
    $.ajax({
        ...
        dataType: 'json',
        url: "../Handler/AuthMgrHandler.ashx",
        data: { visit: 'loaduserservicetypechecked', RoleId: roleId, UserID: UserID },
        success: function (data) {
