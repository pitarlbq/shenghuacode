<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ServiceWuYeTouSuShiXiaoAnalysis.aspx.cs" Inherits="Web.Analysis.ServiceWuYeTouSuShiXiaoAnalysis" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>物业投诉时效统计表</title>
    <script>
    ...
    <script src="../js/Page/Analysis/ServiceWuYeTouSuShiXiaoAnalysis.js?v=<%=base.getToken() %>" type="text/javascript"></script>
    <style>
        .search_item {
