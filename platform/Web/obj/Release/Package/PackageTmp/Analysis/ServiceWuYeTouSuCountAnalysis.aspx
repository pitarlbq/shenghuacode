<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ServiceWuYeTouSuCountAnalysis.aspx.cs" Inherits="Web.Analysis.ServiceWuYeTouSuCountAnalysis" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>物业投诉数量统计表</title>
    <script>
    ...
    <script src="../js/Page/Analysis/ServiceWuYeTouSuCountAnalysis.js?v=<%=base.getToken() %>" type="text/javascript"></script>
    <style>
        .search_item {
    ...
    <div id="main_form_layout" class="easyui-layout" fit="true">
        <div data-options="region:'north',split:false,hideCollapsedContent:false," title="" style="height: 60px; padding: 5px;">
            <form runat="server">
                ...
                <div class="search_item">
                    <input class="easyui-combobox" id="tdServiceTypeName2" style="height: 28px; width: 150px;" data-options="prompt:'请选择二级类别',editable:false" />
                    <asp:HiddenField runat="server" ID="hdServiceTypeName2" />
                </div>
                <div class="search_item">
                    <input class="easyui-combobox" id="tdServiceTypeName3" style="height: 28px; width: 150px;" data-options="prompt:'请选择三级类别',editable:false" />
