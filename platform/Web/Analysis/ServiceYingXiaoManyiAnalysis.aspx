<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ServiceYingXiaoManyiAnalysis.aspx.cs" Inherits="Web.Analysis.ServiceYingXiaoManyiAnalysis" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>营销类投诉处理满意度统计表</title>
    <script>
        $(function () {
            getProjectParams();
    ...
    <script src="../js/Page/Analysis/ServiceYingXiaoManyiAnalysis.js?v=<%=base.getToken() %>" type="text/javascript"></script>
    <style>
        .search_item {
