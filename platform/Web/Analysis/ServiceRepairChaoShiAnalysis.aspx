<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="ServiceRepairChaoShiAnalysis.aspx.cs" Inherits="Web.Analysis.ServiceRepairChaoShiAnalysis" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>维修超时效工单清单</title>
    <script>
        var ColumnServiceStatus = 33, ColumnServiceType = 3;
        $(function () {
            getProjectParams();
    ...
    <script src="../js/Page/Analysis/ServiceRepairChaoShiAnalysis.js?v=<%=base.getToken() %>" type="text/javascript"></script>
    <style>
        .search_item {
