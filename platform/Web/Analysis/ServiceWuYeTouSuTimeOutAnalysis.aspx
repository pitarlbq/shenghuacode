<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NavContent4.Master" AutoEventWireup="true" CodeBehind="ServiceWuYeTouSuTimeOutAnalysis.aspx.cs" Inherits="Web.Analysis.ServiceWuYeTouSuTimeOutAnalysis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Page/Analysis/ServiceWuYeTouSuTimeOutAnalysis.js?v=<%=base.getToken() %>" type="text/javascript"></script>
    <style>
        .search_item {
