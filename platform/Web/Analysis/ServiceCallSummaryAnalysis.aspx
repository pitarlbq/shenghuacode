<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NavContent4.Master" AutoEventWireup="true" CodeBehind="ServiceCallSummaryAnalysis.aspx.cs" Inherits="Web.Analysis.ServiceCallSummaryAnalysis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            if (hdAddUserName.val() != '') {
                userList = eval('(' + hdAddUserName.val() + ')');
            }
            $('#tdAddUserName').combobox({
                editable: false,
                data: userList,
                valueField: 'ID',
                textField: 'Name'
    ...
    <script src="../js/Page/Analysis/ServiceCallSummaryAnalysis.js?v=<%=base.getToken() %>" type="text/javascript"></script>
    <style>
        .search_item {
    ...
    <div id="main_form_layout" class="easyui-layout" fit="true">
        <div data-options="region:'north',split:false,hideCollapsedContent:false," title="" style="height: 60px; padding: 5px;">
            <form runat="server">
                ...
                <div class="search_item">
                    <select class="easyui-combobox" id="tdAddUserName" style="height: 28px; width: 120px;" data-options="prompt:'请选择接听人',editable:false">
                        <option value="">全部</option>
                        <option value="1">客服1</option>
                        <option value="2">客服2</option>
                    </select>
                    <asp:HiddenField runat="server" ID="hdAddUserName" />
                </div>
                <div class="search_item">
