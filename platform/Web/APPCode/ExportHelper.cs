    ...
    public class ExportHelper
    {
        ...
        private static List<Dictionary<string, object>> GetTableColumns(string PageCode, string TableName = "")
        {
            ...
            if (ColumnServiceStatus == 35 && ColumnServiceType == 3)
            {
                ...
                results.Add(dataItem);
                dataItem = new Dictionary<string, object>();
                dataItem["FieldName"] = "AddTime";
                dataItem["ColumnName"] = "登记日期";
                results.Add(dataItem);
                dataItem = new Dictionary<string, object>();
                dataItem["FieldName"] = "BanJieTime";
                dataItem["ColumnName"] = "办结日期";
                results.Add(dataItem);
                dataItem = new Dictionary<string, object>();
                dataItem["FieldName"] = "ChuliNote";
                dataItem["ColumnName"] = "处理结果";
                results.Add(dataItem);
                dataItem = new Dictionary<string, object>();
                dataItem["FieldName"] = "HuiFangNote";
                dataItem["ColumnName"] = "回访结果";
                results.Add(dataItem);
                dataItem = new Dictionary<string, object>();
