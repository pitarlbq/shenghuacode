<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Content.Master" AutoEventWireup="true" CodeBehind="UserDepartmentMgr.aspx.cs" Inherits="Web.UserInfo.UserDepartmentMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Page/UserInfo/UserDepartmentMgr.js?v=<%=base.getToken() %>"></script>
    <style>
        .labelMore {
            position: relative;
    ...
    <div id="cc" class="easyui-layout" fit="true">
        <div data-options="region:'center',border:false" style="width: 400px; border: 1px solid #d0d0d0; border-left: none;">
            <div class="easyui-panel" title="" style="width: 100%; padding: 5px 0;" data-options="border:false">
                <label>
                    关键字:
                     <input class="easyui-searchbox" id="tdDepartmentName" type="text" data-options="prompt:'部门名称搜索',searcher:doSearchDepartment" />
                </label>
                <label>
                    <a href="javascript:void(0)" onclick="doSearchDepartment()" class="easyui-linkbutton btntoolbar" data-options="plain:true,iconCls:'icon-search'">查询</a>
                </label>
            </div>
                ...
                <table id="notr" class="easyui-datagrid" data-options="border:false" singleselect="true">
                    <thead>
                        <tr>
                            ...
                            <th field="DepartmentName" width="100%" align="center">未有部门</th>
                        </tr>
                    </thead>
                </table>
            ...
            <div class="easyui-panel" title="" style="width: 100%; padding: 5px 0; border: 1px solid #d0d0d0; border-left: none; border-right: none;" data-options="border:false">
                <div style="text-align: center;">
                    ...
                    <a href="javascript:void(0)" onclick="leftRole()" class="easyui-linkbutton btntoolbar" data-options="plain:true,iconCls:'icon-add'">赋予</a>
                    <a href="javascript:void(0)" onclick="rightRole()" class="easyui-linkbutton btntoolbar" data-options="plain:true,iconCls:'icon-remove'">移除</a>
                </div>
            </div>
            <div class="easyui-panel" title="" style="width: 100%; height: 35%; border: none; border-bottom: 1px solid #d0d0d0;" data-options="border:false">
                <table id="inr" class="easyui-datagrid" singleselect="true" data-options="border:false,">
                    <thead>
                        <tr>
                            <th field="ID" align="center" hidden="true">编号</th>
                            <th field="DepartmentName" width="100%" align="center">已有部门</th>
                        </tr>
                    </thead>
                </table>
